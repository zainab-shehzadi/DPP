    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="lg:ml-64 p-4 sm:p-8 w-full">
          ...
          <div className="flex flex-wrap items-center space-x-2 w-full lg:w-auto mt-4 lg:mt-0">
            ...
            {visibleCount < facilities.length ? (
              ...
              <button
                ...
                onClick={() =>
                  setSelectedFacility(facilities[visibleCount - 1])
                }
                className={`px-4 py-2 rounded-md text-xs sm:text-sm lg:text-base whitespace-nowrap transition-all duration-150 ${
        ...
        <div className="flex flex-col lg:flex-row justify-center mt-4 lg:mt-8 space-y-4 lg:space-y-0 lg:space-x-4">
          {/* Left Container */}
          <div className="bg-white shadow-lg p-4 sm:p-6 flex flex-col justify-between w-full lg:w-[600px] h-auto rounded-lg border border-[#E0E0E0] mx-auto">
            <div>
              ...
              >
                <p>
                  F-12347 defines dolor sit amet consectetur. Tortor enim id
                  phasellus ac amet quam integer.
                </p>
                <p>
                  Id maecenas tortor tristique vel pretium eget. Sed commodo
                  varius mauris mi consequat ac tincidunt facilisis vel.
                </p>
              </div>
            </div>
            <button
          ...
          <div className="bg-white border shadow-lg rounded-lg p-4 sm:p-6 w-full h-auto flex flex-col justify-between">
            <div>
              <h4 className="font-bold text-lg sm:text-xl lg:text-2xl leading-tight text-[#494D55] mb-3 lg:mb-12">
                F-12347
              </h4>
              <p
              ...
              >
                Lorem ipsum dolor sit amet consectetur. Tortor enim id phasellus
                ac amet quam integer. Id maecenas tortor tristique vel pretium
                eget. Sed commodo varius mauris mi consequat ac tincidunt
                facilisis vel. Senectus duis pulvinar sed mauris ornare elit sed
                neque. Eu leo bibendum molestie congue fusce consequat eu
                volutpat enim. Pharetra egestas arcu morbi augue. Id
                pellentesque lectus velit nibh amet lacus risus a commodo. Vitae
                nibh eget euismod purus orci. Lacus ac velit morbi pellentesque.
                Iaculis pellentesque risus sagittis vivamus. Tempus amet morbi
                et tellus feugiat a feugiat elit dui. Arcu euismod nibh auctor
                eu gravida. Risus non cras
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border shadow-lg rounded-lg p-4 sm:p-6 w-full h-auto flex flex-col justify-between">
            ...
            <div className="flex space-x-3 sm:space-x-5 mt-4 lg:mt-8">
              <button className="text-[#002F6C] hover:text-blue-900 text-sm sm:text-base">
                <FaFileAlt />
              </button>
              <button className="text-[#002F6C] hover:text-blue-900 text-sm sm:text-base">
                <FaUpload />

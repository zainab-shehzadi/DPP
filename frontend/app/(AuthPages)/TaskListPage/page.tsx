...
function TaskList() {
  ...
  useEffect(() => {
    ...
    if (savedDocId && documents.length > 0) {
      const matched = documents.find((doc) => doc._id === savedDocId);
      if (matched) {
...
>
    ...
    >
      <ul className="py-2 text-sm text-gray-700">
        {["To Do", "In Progress", "Closed"].map((col) => (
          ...
          <h3 className="font-bold text-sm md:text-md break-words whitespace-normal overflow-wrap-break-word">
  ...
  const columnOrder = ["To Do", "In Progress", "Closed"];
          ...
          <div className="lg:ml-64 p-4 sm:p-8 w-full">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-8 justify-between items-stretch">
                ...
                {/* Task Summary Box */}
                <div className="bg-[#F6F6F6] p-4 rounded-[17px] flex flex-col justify-center w-full">
            ...
            if (selectedDocId) {
              ...
              if (res.ok) {
                const updated = data.tasks
                  ...
                  .reverse(); // 👈 Show latest task at the top
                setTasks(updated);
              }
            }
          }}
